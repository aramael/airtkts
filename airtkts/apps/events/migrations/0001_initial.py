...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field owner on 'Event'
        m2m_table_name = db.shorten_name(u'events_event_owner')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field owner on 'Event'
        db.delete_table(db.shorten_name(u'events_event_owner'))
