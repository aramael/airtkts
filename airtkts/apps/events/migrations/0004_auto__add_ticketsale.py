...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TicketSale'
        db.create_table(u'events_ticketsale', (
            ...
            ('minimum_ordered', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('maximum_ordered', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('show_remaining_count', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'events', ['TicketSale'])


    def backwards(self, orm):
        # Deleting model 'TicketSale'
        db.delete_table(u'events_ticketsale')
