...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketOrder.payment_method'
        db.add_column(u'events_ticketorder', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(default='cc', max_length=10),
                      keep_default=False)


        # Changing field 'TicketOrder.charge'
        db.alter_column(u'events_ticketorder', 'charge', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'TicketOrder.payment_method'
        db.delete_column(u'events_ticketorder', 'payment_method')


        # Changing field 'TicketOrder.charge'
        db.alter_column(u'events_ticketorder', 'charge', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
