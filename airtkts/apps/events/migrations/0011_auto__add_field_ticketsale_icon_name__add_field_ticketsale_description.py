...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketSale.icon_name'
        db.add_column(u'events_ticketsale', 'icon_name',
                      self.gf('django.db.models.fields.CharField')(default='ticket', max_length=25, null=True),
                      keep_default=False)

        # Adding field 'TicketSale.description'
        db.add_column(u'events_ticketsale', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketSale.icon_name'
        db.delete_column(u'events_ticketsale', 'icon_name')

        # Deleting field 'TicketSale.description'
        db.delete_column(u'events_ticketsale', 'description')
