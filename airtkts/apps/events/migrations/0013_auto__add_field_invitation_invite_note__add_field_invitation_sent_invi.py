...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.invite_note'
        db.add_column(u'events_invitation', 'invite_note',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Invitation.sent_invite'
        db.add_column(u'events_invitation', 'sent_invite',
                      self.gf('django.db.models.fields.TextField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invitation.invite_note'
        db.delete_column(u'events_invitation', 'invite_note')

        # Deleting field 'Invitation.sent_invite'
        db.delete_column(u'events_invitation', 'sent_invite')
    ...
    models = {
        ...
        u'events.invitation': {
            ...
            'invite_note': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'sent_invite': ('django.db.models.fields.TextField', [], {'default': 'False'}),
        ...
        u'events.ticketsale': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.Event']"}),
            'icon_name': ('django.db.models.fields.CharField', [], {'default': "'ticket'", 'max_length': '25', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
