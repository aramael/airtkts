...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketOrder.balance'
        db.add_column(u'events_ticketorder', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketOrder.balance'
        db.delete_column(u'events_ticketorder', 'balance')
