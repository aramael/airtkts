...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.invite_key'
        db.add_column(u'events_invitation', 'invite_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Invitation.rsvp_status'
        db.add_column(u'events_invitation', 'rsvp_status',
                      self.gf('django.db.models.fields.CharField')(default='--', max_length=12),
                      keep_default=False)

        # Adding field 'Invitation.ticket_order'
        db.add_column(u'events_invitation', 'ticket_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.TicketOrder'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invitation.invite_key'
        db.delete_column(u'events_invitation', 'invite_key')

        # Deleting field 'Invitation.rsvp_status'
        db.delete_column(u'events_invitation', 'rsvp_status')

        # Deleting field 'Invitation.ticket_order'
        db.delete_column(u'events_invitation', 'ticket_order_id')
