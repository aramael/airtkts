...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invitation.max_guest_count'
        db.alter_column(u'events_invitation', 'max_guest_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Invitation.max_guest_count'
        db.alter_column(u'events_invitation', 'max_guest_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=''))
